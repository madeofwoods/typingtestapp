  ...
  return (
    <div className="w-full flex flex-2 justify-center">
      <div id="wordsContainer" className=" w-[550px]  md:w-[650px] lg:w-[800px]  select-none min-h-[230px] relative">
        ...
        <input
          type="text"
          className="block md:hidden bg-gray-900/0 w-[100%] h-[180px] absolute opacity-5 caret-transparent cursor-pointer pt-28 overflow-hidden rounded-3xl text-black/0 outline-none focus:outline-none hover:outline-none"
          placeholder=""
          value={typedChars}
          ref={inputElement}
          onClick={() => {
